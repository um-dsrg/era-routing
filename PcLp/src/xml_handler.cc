...
void
XmlHandler::saveResults (linkContainer_t &links, pathContainer_t &paths, flowContainer_t &flows,
      ...
      for (Path *path : flow->getPaths ())
        {
          ...
          pathElement->SetAttribute ("DataRate",
                                     lpSolver.GetLpColValue (path->getDataRateLpVar ()));
